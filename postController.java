...
import com.firstPro.response.ApiResponse;
import com.firstPro.service.postService;
...
public class postController {
	...
	public ResponseEntity<ApiResponse> deletePost(
		...
		User reqUser = userService.findUserByJwt(jwt);
		String mesaage = postService.deletePost(postId,reqUser.getId());
		
		ApiResponse res = new ApiResponse(mesaage,true);
